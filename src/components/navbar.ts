...
export default class Navbar extends Component {
    ...
    constructor(brand: Component | Link, ...links: Link[]) {
        super("div", { id: "navbar-root" });
        this.addClasses("navbar");
        console.log(this.getParent())

        const hamburger = new Component("a", { class: "icon", onclick: `document.getElementById('navbar-root').classList.toggle('responsive')` });
        ...
        this.addChildren(brand,...links,hamburger);
    }
}